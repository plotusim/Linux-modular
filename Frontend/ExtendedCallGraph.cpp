...
class ExtendedCallGraph : public ModulePass {
public:
    static char ID;
    ExtendedCallGraph() : ModulePass(ID) {}
...
char ExtendedCallGraph::ID = 0;

// true: module pass   ;   true: won't change module
static RegisterPass<ExtendedCallGraph> X("ExtendedCallGraph", "Extended Call Graph Pass", true, true);
